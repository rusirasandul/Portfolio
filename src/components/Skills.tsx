...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    {
      title: "Backend",
      skills: ["Java", "Spring Boot", "Python", "C#", "JavaScript", "Node.js", "Nest.js", "Express", ".NET", "RESTful APIs"]
    },
    {
      title: "Database",
  ...
  return (
    <section id="skills" className="section-padding bg-slate-950 hexagon-bg">
